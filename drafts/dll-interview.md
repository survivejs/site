...
Now that the bases are covered, a more advanced use case is more easily digestable:
...
<!-- ...Using the core plugin which requires adding double the build scripts, double the configs, moving your dependencies, building the manifest manually... -->
...
</details>& found there was no webpack documentation for the [DLLPlugin][DLLPlugin], so as I researched, experimented, & wrote the documentation, I discovered how powerful it was, but also how extremely clunky the config required to use it was.
