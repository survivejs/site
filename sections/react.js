  ...
  return {
    ...
    path: function() {
      return require.context(
        "json!yaml-frontmatter!../../react/manuscript",
        true,
        /^\.\/.*\.md$/
      );
    },
    ...
    sort: function(files) {
      var order = require("raw!../../react/manuscript/Book.txt")
        .split("\n")
        .filter(id);
      var ret = [];
    ...
    inject: function(files) {
      var sourcePrefix =
        "https://github.com/survivejs/react/tree/master/project_source/";
      var reqResource = require.context(
        "json!../resources/react/",
        true,
        /^\.\/.*\.json$/
      );
