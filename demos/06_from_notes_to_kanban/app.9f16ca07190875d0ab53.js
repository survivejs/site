...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsAlt = __webpack_require__(185);

	var _libsAlt2 = _interopRequireDefault(_libsAlt);

	var _libsStorage = __webpack_require__(201);

	var _libsStorage2 = _interopRequireDefault(_libsStorage);

	var _libsPersist = __webpack_require__(202);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(9);
	var LocalEventTrapMixin = __webpack_require__(97);
	var ReactBrowserComponentMixin = __webpack_require__(98);
	var ReactClass = __webpack_require__(41);
	var ReactElement = __webpack_require__(15);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altAltContainer = __webpack_require__(158);
	...
	var _LanesJsx = __webpack_require__(180);

	var _LanesJsx2 = _interopRequireDefault(_LanesJsx);

	var _actionsLaneActions = __webpack_require__(199);

	var _actionsLaneActions2 = _interopRequireDefault(_actionsLaneActions);

	var _storesLaneStore = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mixinContainer = __webpack_require__(177)
	var assign = __webpack_require__(179).assign
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Subscribe = __webpack_require__(178)
	var assign = __webpack_require__(179).assign
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _LaneJsx = __webpack_require__(181);
	...
	var Lanes = (function (_React$Component) {
	  ...
	  _createClass(Lanes, [{
	    ...
	    value: function renderLane(lane) {
	      return _react2['default'].createElement(_LaneJsx2['default'], _extends({ className: 'lane', key: 'lane' + lane.id }, lane));
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NotesJsx = __webpack_require__(182);

	var _NotesJsx2 = _interopRequireDefault(_NotesJsx);

	var _actionsNoteActions = __webpack_require__(184);

	var _actionsNoteActions2 = _interopRequireDefault(_actionsNoteActions);

	var _storesNoteStore = __webpack_require__(197);
	...
	var _EditableJsx = __webpack_require__(183);
	...
	var Lane = (function (_React$Component) {
	  ...
	  function Lane() {
	    ...
	    _get(Object.getPrototypeOf(Lane.prototype), 'constructor', this).apply(this, arguments);
	  }
	  ...
	  _createClass(Lane, [{
	    ...
	    value: function render() {
	      ...
	      var props = _objectWithoutProperties(_props, ['id', 'name', 'notes']);
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_EditableJsx2['default'], { className: 'lane-name', value: name,
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	              'button',
	              { onClick: this.addNote.bind(null, id) },
	              '+'
	            )
	          )
	        ),
	        _react2['default'].createElement(
	          _altAltContainer2['default'],
	          {
	            ...
	            inject: {
	              items: function items() {
	                return _storesNoteStore2['default'].get(notes);
	              }
	            }
	          },
	          _react2['default'].createElement(_NotesJsx2['default'], {
	    ...
	    key: 'editNote',
	    value: function editNote(noteId, task) {
	      _actionsNoteActions2['default'].update({ id: noteId, task: task });
	    }
	  }, {
	    key: 'deleteNote',
	  ...
	  _createClass(Notes, [{
	    ...
	    value: function renderNote(note) {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(_EditableJsx2['default'], {
	          value: note.task,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _utilsFunctions = __webpack_require__(179);
	...
	var _utilsAltUtils = __webpack_require__(188);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AltStore = __webpack_require__(189);

	var _AltStore2 = _interopRequireDefault(_AltStore);

	var _StoreMixin = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _transmitter = __webpack_require__(190);
	...
	var NoteStore = (function () {
	  ...
	  _createClass(NoteStore, [{
	    ...
	    value: function get(ids) {
	      var notes = this.notes || [];
	      var notesIds = notes.map(function (note) {
	        return note.id;
	      });

	      if (ids) {
	        return ids.map(function (id) {
	          return notes[notesIds.indexOf(id)];
	        });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NoteStore = __webpack_require__(197);
	...
	var LaneStore = (function () {
	  ...
	  _createClass(LaneStore, [{
	    ...
	    value: function attachToLane(_ref2) {
	      ...
	      if (!noteId) {
	        this.waitFor(_NoteStore2['default']);

	        noteId = _NoteStore2['default'].getState().notes.slice(-1)[0].id;
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _altUtilsMakeFinalStore = __webpack_require__(203);
